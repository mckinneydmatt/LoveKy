        ...
        defineField({
          ...
          fields: [
            ...
            defineField({
              ...
              type: 'string',
              description: fallbackHint,
              placeholder: siteFallback(site.order.form.quantityLabel),
            }),
            defineField({
            ...
            defineField({
              ...
              type: 'string',
              description: fallbackHint,
              placeholder: siteFallback(site.order.form.ingredientsLabel),
            }),
            defineField({
              name: 'disclaimerAckLabel',
              title: 'Disclaimer checkbox label',
              type: 'string',
              description: `Text next to the required checkbox confirming the disclaimer above it. ${fallbackHint}`,
              placeholder: siteFallback(site.order.form.disclaimerAckLabel),
            }),
            defineField({
              name: 'submitLabel',
