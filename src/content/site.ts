export const site = {
  ...
  about: {
    ...
    paragraphs: [
      "I've been baking for over 10 years, but this cake – the cake – started with my mom's birthday. I made it for her, and from that moment on, my family never let me forget it. Birthdays, holidays, random Tuesdays – someone was always asking for it. Then friends started asking. Then co-workers. And every time, without fail, I'd hear the same thing:",
      "Kylee, you could sell this.",
      ...
      "For the first time in my adult life, I didn't have a job. And I found myself asking: What do I actually want to do?",
      ...
      "Love, Ky is how I've been signing notes for as long as I can remember, and a friend pointed out that I always sign with a heart. Genuine love and care goes into everything I do. Every cake that leaves my kitchen goes out the same way – signed Love, Ky with a heart – because that's not branding. That's just how I do things.",
